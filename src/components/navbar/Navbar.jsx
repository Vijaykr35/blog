    ...
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      {!admin
        ...
        <Typography
          ...
          style={{ color: mode === 'dark' ? 'white' : 'white' }}
        >
          <Link to={'/adminlogin'} className="flex items-center hover:text-gray-500">
            Login
          </Link>
        </Typography>
        :
  ...
  return (
    <>
      ...
      <Navbar
        ...
        style={{ background: mode === 'dark' ? 'rgb(30, 41, 59)' : 'rgb(79 70 229)' }}>
        ...
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <Link to={'/'}>
            ...
            >
              ...
              <img
                className=' w-10 h-10 '
                src='https://img.icons8.com/?size=100&id=58240&format=png&color=000000'
              />
              {/* Logo Text  */}
              <span>
                MyBlogs
